...
public class MainActivity extends AppCompatActivity {
    // Merchant server url
    private static final String SERVER_URL = "https://api.micuentaweb.pe/api-payment/V4/Charge"; // without / at the end, example https://myserverurl.com
    ...
    private static final String SERVER_AUTH_USER = "~~CHANGE_ME_BACKOFFICE_USER~~";
    private static final String SERVER_AUTH_TOKEN = "~~CHANGE_ME_BACKOFFICE_TEST/PRODUCTION PASSWORD~~";
    ...
    private static final String ORDER_ID = "Test-1";
